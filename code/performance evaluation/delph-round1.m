%% Supplementary Note S8 - Delphi Method Analysis (Round 1)
%
% Author: Songkai Liu @ Shanghai Jiao Tong University
% Date: 2025-04-07
%
% This script implements the full analysis pipeline for the first round of Delphi method expert evaluations.
%
% Features:
% - Analyzes expert scoring consistency across six design challenges.
% - Computes Kendall's coefficient of concordance (W) and statistical significance (Chi-square test).
% - Evaluates robustness indicators: Mean, Standard Deviation (StdDev), Coefficient of Variation (CV), and Full-Score Rate (FSR).
% - Identifies potential inconsistencies using global statistical thresholds.
% - Exports CSV files for boxplot visualization and Excel reports of evaluation results.
% - Visualizes expert agreement via Kendall's W bar charts.
%
% Outputs:
% - 'Delphi_Threshold_Summary.xlsx' (Threshold Summary)
% - 'Delphi_Indicator_Judgment.xlsx' (Detailed Evaluation Results)
% - 'Boxplot_*.csv' (CSV files for Origin plotting)
